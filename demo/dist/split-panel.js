(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.SplitPanel = {}));
	...
	*/
	var SplitPanelGroup = class extends HTMLElement {
		...
		*/
		...
		#createDividers() {
			for (const divider of this.querySelectorAll(":scope > split-divider")) divider.remove();
	...
	*/
	...
	//#endregion
	exports.SplitDivider = SplitDivider;
	exports.SplitPanel = SplitPanel;
	exports.SplitPanelGroup = SplitPanelGroup;
});
